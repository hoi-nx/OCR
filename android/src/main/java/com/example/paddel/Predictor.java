...
public class Predictor {
    ...
    public interface CallBackRuningModel{
        void callBack(String kq);

    }
    public boolean runModel(int run_det, int run_cls, int run_rec,CallBackRuningModel callBackRuningModel) {
        ...
        drawResults(results,callBackRuningModel);
    ...
    private void drawResults(ArrayList<OcrResultModel> results,CallBackRuningModel callBackRuningModel) {
        ...
        callBackRuningModel.callBack(outputResult);
